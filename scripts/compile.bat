...
cd scripts
cl.exe /LDd /DEBUG /I"D:\Projects\LumixEngine\src" "%1" /link /DYNAMICBASE "kernel32.lib" "user32.lib" "core.lib" "engine.lib"  /DEBUG /LIBPATH:"D:\Projects\LumixEngine\bin\Win32_Debug"
exit %errorlevel%
