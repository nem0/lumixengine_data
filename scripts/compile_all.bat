...
msbuild %1
REM cl.exe /LDd /I"D:\Projects\LumixEngine\src" "%1" /link /DYNAMICBASE "kernel32.lib" "user32.lib" "core.lib" "engine.lib" "physics.lib"  /LIBPATH:"D:\Projects\LumixEngine\bin\Win32_Release"
REM exit %errorlevel%
