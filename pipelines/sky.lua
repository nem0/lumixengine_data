local procedural_sky_shader = nil
...
function postprocess(env, transparent_phase, hdr_buffer, gbuffer0, gbuffer1, gbuffer_depth, shadowmap)
	...
	env.beginBlock("sky")
	if procedural_sky_shader == nil then
		procedural_sky_shader = env.preloadShader("pipelines/procedural_sky.shd")
	end
	...
	env.drawArray(0, 4, procedural_sky_shader)
